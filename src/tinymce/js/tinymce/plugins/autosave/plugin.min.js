...
! function() {
  ...
  const n = t => {
    ...
    p = (t, e) => {
      const r = m(t);
      a.removeItem(r + 'draft'), a.removeItem(r + 'time'), !1 !== e && (t => {
        t.dispatch('RemoveDraft');
      })(t);
    },
    g = t => {
      const e = m(t);
      !v(t) && t.isDirty() && (a.setItem(e + 'draft', t.getContent({
        format: 'raw',
        no_events: !0
      })), a.setItem(e + 'time', (new Date).getTime().toString()), (t => {
    ...
    y = t => {
      var e;
      const r = m(t);
      f(t) && (t.setContent(null !== (e = a.getItem(r + 'draft')) && void 0 !== e ? e : '', {
        format: 'raw'
      }), (t => {
